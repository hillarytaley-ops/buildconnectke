      ...
      <div className="min-h-screen bg-gradient-construction">
        ...
        >
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl max-w-3xl mx-auto text-text-dark-green font-medium drop-shadow-md">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              <div className="focus-within:ring-2 focus-within:ring-black rounded-lg p-4" tabIndex={0}>
                <div className="text-4xl font-bold mb-2 text-text-medium-blue" aria-label="One thousand plus">1,000+</div>
                <div className="text-lg text-text-dark-green">Active Builders</div>
              </div>
              <div className="focus-within:ring-2 focus-within:ring-black rounded-lg p-4" tabIndex={0}>
                <div className="text-4xl font-bold mb-2 text-text-medium-blue" aria-label="Five hundred plus">500+</div>
                <div className="text-lg text-text-dark-green">Verified Suppliers</div>
              </div>
              <div className="focus-within:ring-2 focus-within:ring-black rounded-lg p-4" tabIndex={0}>
                <div className="text-4xl font-bold mb-2 text-text-medium-blue" aria-label="Ten thousand plus">10,000+</div>
                <div className="text-lg text-text-dark-green">Successful Connections</div>
              </div>
              <div className="focus-within:ring-2 focus-within:ring-black rounded-lg p-4" tabIndex={0}>
                <div className="text-4xl font-bold mb-2 text-text-medium-blue" aria-label="Two billion Kenyan Shillings plus">KSh 2B+</div>
                <div className="text-lg text-text-dark-green">Total Transactions</div>
              </div>
            </div>
          </div>
        </section>
